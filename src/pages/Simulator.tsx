...
export default function Simulator() {
  ...
  const canProceed = (): boolean => {
    switch (currentStep) {
      ...
      case 3: return true; // battery always has a value
      case 4: return !!data.condition;
      case 5: return DEFECT_QUESTIONS.every(q => data.defects[q.key as keyof DefectsData] !== null);
  ...
  const renderStep = () => {
    switch (currentStep) {
      case 0: return <StepModel data={data} onUpdate={updateData} />;
      case 1: return <StepStorage data={data} onUpdate={updateData} />;
      case 2: return <StepColor data={data} onUpdate={updateData} />;
      case 3: return <StepBattery data={data} onUpdate={updateData} />;
      case 4: return <StepCondition data={data} onUpdate={updateData} />;
      case 5: return <StepDefects data={data} updateDefect={updateDefect} />;
      case 6: return <StepPhotos data={data} onUpdate={updateData} />;
      case 7: return <StepDesired data={data} onUpdate={updateData} />;
